...
export default function DetailLaporan() {
  ...
  const { nip } = router.query; // Mengakses nilai dari query parameter 'nip'
  ...
  const { data: tables = [], error } = useSWR(nip? `/api/admin/dosen/laporanDatadosen?nip=${nip}`:null, fetcher );

      ...
      <div className="grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4 px-8">
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md  h-[70%] mt-8 ">
          ...
          <div className="p-4 text-right">
            <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">{totDosen}</p>
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md  h-[70%] mt-8">
          ...
          <div className="p-4 text-right">
            <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">{totmahasiswa}</p>
            <h4 className="block antialiased tracking-normal font-sans text-4xl font-semibold leading-snug text-blue-gray-900">{jmlMahasiswa}</h4>
            <div className='flex justify-start ml-6'>
              <div className='bg-green-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-pink-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-blue-600 rounded-full w-3 h-3  mx-1'></div>
        ...
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md  h-[70%] mt-8">
          ...
          <div className="p-4 text-right">
            <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">{mahasiswaWanita}</p>
            <h4 className="block antialiased tracking-normal font-sans text-4xl font-semibold leading-snug text-blue-gray-900 pr-4 ">{jmlWanita}</h4>
            <div className='flex justify-start ml-6'>
              <div className='bg-green-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-pink-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-blue-600 rounded-full w-3 h-3  mx-1'></div>
        ...
        <div className="bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-green-500/40 shadow-lg absolute -mt-4 grid h-16 w-16 place-items-center">
          ...
          <div className="p-4 text-right">
            <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">{mahasiswaPria}</p>
            <h4 className="block antialiased tracking-normal font-sans text-4xl font-semibold leading-snug text-blue-gray-900 pr-4">{jmlPria}</h4>
            <div className='flex justify-start ml-6'>
              <div className='bg-green-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-pink-600 rounded-full w-3 h-3 mx-1'></div>
              <div className='bg-blue-600 rounded-full w-3 h-3  mx-1'></div>
            ...
            <div className='mt-2'>
              {lokasiKkn.map((lokasi) =>(
                <div key={lokasi.id} className='flex items-center space-x-2 py-2'>
                  ...
                  <h3 className='font-medium pr-1' key={lokasi}>{lokasi.lokasi}: </h3>
                  <p key={lokasi}>{lokasi.titik}</p>
                  </div>
                </div>
              ))}
            </div>

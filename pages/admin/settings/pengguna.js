...
export default function Pengguna() {
  ...
  return (
    <>
    <div className=' bg-IjoRumput w-screen h-screen pl-32 py-4 flex items-start '>
      <img src='/nav-logo.png' className='w-[90px] '/>
      <div className='flex justify-center items-center w-2/3 ml-16 mt-16'>
        <div className='w-full'>
          <div className="flex flex-col items-center justify-center overflow-hidden">
            <h1 className="text-3xl font-bold text-center text-gray-700 mb-4">Create New Account</h1>
              <div>
                <button href="/login/mahasiswa"
                 style={{
                  backgroundColor: userType === 'mahasiswa' ? '#dde5d9' : 'initial',
                  color: 'black',
                  padding: '5px 16px',
                  border: 'none',
                  borderRadius: '4px',
                ...
                <button href="/login/dosen"
                   style={{
                    backgroundColor: userType === 'dosen' ? '#dde5d9' : 'initial',
                    color: 'black',
                    padding: '5px 16px',
                    border: 'none',
                    borderRadius: '4px',
                  ...
                  <button href="/login/admin"
                   style={{
                    backgroundColor: userType === 'admin' ? '#dde5d9' : 'initial',
                    color: 'black',
                    padding: '5px 16px',
                    border: 'none',
                    borderRadius: '4px',

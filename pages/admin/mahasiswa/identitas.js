...
export default function Identitas() {
    ...
    [
      {
        ...
        angkatan: "2020",
        lokasi: "Jawa Barat, Kabupaten Bandung, Kec Paseh, Desa Cipedes",
        notlp: "089647381823"
      },
      {
        id: 2,
  ...
  const searchFilter = (item) => {
    const { name, nim, fakultas, jurusan, jenis, kelompok, angkatan, lokasi } = item;
        ...
        <table className='text-lg text-gray-500 dark:text-gray-400 w-full'>
          <thead className=' text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-center'>
            <tr className=''>
              ...
              <th scope='col' className='py-2 px-2'>Telepon</th>
              <th scope='col' className='py-2 px-2'>Fakultas</th>
              <th scope='col' className='py-2 px-2'>Jurusan</th>
              <th scope='col' className='py-2 px-2'>Angkatan</th>
          ...
          <tbody className='text-center'>
            {displayData().map((table, i) => (
              ...
              <td scope='col' className='py-1 px-2'>{table.angkatan}</td>

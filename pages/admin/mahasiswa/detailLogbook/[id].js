...
export default function DetailLogbook() {
  ...
  return (
    ...
    <div className='absolute bg-IjoRumput h-screen w-screen'>
      <h1 className='flex justify-center items-center text-white text-4xl font-bold mt-5'>Detail Logbook Mahasiswa</h1>
      <div class="absolute px-5 md:left-24 md:right-24 md:top-20 py-5 rounded-xl bg-iceGray flex justify-between h-auto w-auto">

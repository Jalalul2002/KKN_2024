...
export default async function handler(req, res) {
  if (req.method === "POST") {
    const { nip, dosen_name, jurusan_dosen, fakultas_dosen, telpon_dosen } = req.body;
    ...
    try {
      ...
      const [result] = await condb
        .promise()
        .query("INSERT INTO dosen (nip, nama, jurusan_dosen, fakultas_dosen, telpon_dosen) VALUES (?, ?, ?, ?, ?)", [nip, dosen_name, jurusan_dosen || null, fakultas_dosen || null, telpon_dosen || null]);
